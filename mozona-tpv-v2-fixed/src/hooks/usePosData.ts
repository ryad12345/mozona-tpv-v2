...
const MOCK_RESTAURANT: Restaurant = {
    id: "rest-demo", slug: "demo",
    business_name: "MOZONA TPV",
    cif_nif: "B12345678",
...
const MOCK_PRODUCTS: Product[] = [
    { id: "p-1", restaurant_id: "rest-1", category_id: "c-1", name: "Paella Valenciana",  description: "Arroz, pollo, conejo, judía, garrofón", price: 14.50, tax_rate: 10, is_available: true },
    { id: "p-2", restaurant_id: "rest-1", category_id: "c-1", name: "Arroz Negro",        description: "Tinta de calamar, alioli",            price: 15.00, tax_rate: 10, is_available: true },
    { id: "p-3", restaurant_id: "rest-1", category_id: "c-1", name: "Arroz del Señorito", description: "Marisco, pescado, caldo",              price: 16.50, tax_rate: 10, is_available: true },
    { id: "p-4", restaurant_id: "rest-1", category_id: "c-2", name: "Solomillo de Ternera", description: "Pimienta verde, patatas",            price: 19.90, tax_rate: 10, is_available: true },
    { id: "p-5", restaurant_id: "rest-1", category_id: "c-2", name: "Chuletón de Buey",     description: "1kg, maduración 30 días",            price: 38.00, tax_rate: 10, is_available: true },
    { id: "p-6", restaurant_id: "rest-1", category_id: "c-2", name: "Presa Ibérica",       description: "Parrilla, sal Maldon",               price: 16.50, tax_rate: 10, is_available: true },
    { id: "p-7", restaurant_id: "rest-1", category_id: "c-3", name: "Lubina a la Espalda", description: "A la espalda, refrito",              price: 18.50, tax_rate: 10, is_available: true },
    { id: "p-8", restaurant_id: "rest-1", category_id: "c-3", name: "Bacalao al Pil-Pil",  description: "Pil-pil tradicional",                 price: 17.00, tax_rate: 10, is_available: true },
    { id: "p-9",  restaurant_id: "rest-1", category_id: "c-4", name: "Patatas Bravas",        price: 6.50,  tax_rate: 10, is_available: true, description: null },
    { id: "p-10", restaurant_id: "rest-1", category_id: "c-4", name: "Croquetas de Jamón",    price: 7.50,  tax_rate: 10, is_available: true, description: null },
    { id: "p-11", restaurant_id: "rest-1", category_id: "c-4", name: "Tortilla Española",     price: 6.00,  tax_rate: 10, is_available: true, description: null },
    { id: "p-12", restaurant_id: "rest-1", category_id: "c-4", name: "Gazpacho Andaluz",      price: 5.50,  tax_rate: 10, is_available: true, description: null },
    { id: "p-13", restaurant_id: "rest-1", category_id: "c-5", name: "Tarta de Queso",        price: 5.50, tax_rate: 10, is_available: true, description: null },
    { id: "p-14", restaurant_id: "rest-1", category_id: "c-5", name: "Coulant de Chocolate",  price: 6.00, tax_rate: 10, is_available: true, description: null },
    { id: "p-15", restaurant_id: "rest-1", category_id: "c-5", name: "Helado Artesano",       price: 4.50, tax_rate: 10, is_available: true, description: null },
    { id: "p-16", restaurant_id: "rest-1", category_id: "c-6", name: "Cerveza Mahou",         price: 2.50, tax_rate: 21, is_available: true, description: null },
    { id: "p-17", restaurant_id: "rest-1", category_id: "c-6", name: "Cerveza 1906",         price: 3.20, tax_rate: 21, is_available: true, description: null },
    { id: "p-18", restaurant_id: "rest-1", category_id: "c-6", name: "Agua Mineral",          price: 1.80, tax_rate: 10, is_available: true, description: null },
    { id: "p-19", restaurant_id: "rest-1", category_id: "c-6", name: "Refresco",              price: 2.50, tax_rate: 10, is_available: true, description: null },
    { id: "p-20", restaurant_id: "rest-1", category_id: "c-7", name: "Vino Tinto (copa)",     price: 3.50, tax_rate: 21, is_available: true, description: null },
    { id: "p-21", restaurant_id: "rest-1", category_id: "c-7", name: "Vino Blanco (copa)",    price: 3.50, tax_rate: 21, is_available: true, description: null },
    { id: "p-22", restaurant_id: "rest-1", category_id: "c-8", name: "Café Solo",              price: 1.50, tax_rate: 10, is_available: true, description: null },
    { id: "p-23", restaurant_id: "rest-1", category_id: "c-8", name: "Café con Leche",         price: 1.80, tax_rate: 10, is_available: true, description: null },
    { id: "p-24", restaurant_id: "rest-1", category_id: "c-8", name: "Cortado",                price: 1.60, tax_rate: 10, is_available: true, description: null },
];
